...
const YouMustSelfIsolate: React.FC<YouMustSelfIsolateProps> = () => (
    <>
        <AssessmentHeaderView>
            <AssessmentHeaderText>
                You must immediately self-isolate. You may need to be tested for COVID-19.
            </AssessmentHeaderText>
        </AssessmentHeaderView>
        ...
        <AssessmentDescriptionView>
            <AssessmentDescriptionText>
                As of March 25, Albertans are legally required under public health order
                to self-isolate for 10 days from the onset of any COVID-19 symptoms which
                are not related to a pre-existing illness or health condition. If your
                symptoms resolve prior to the 10 days, you must continue to self-isolate
                because you may still be infectious.
            </AssessmentDescriptionText>
        </AssessmentDescriptionView>
        <AssessmentDescriptionView>
            <AssessmentDescriptionText>
            ...
            <AssessmentDescriptionText>
                ...
                chronic conditions, a compromised immune system, or seniors (over 65 years
                of age).
            </AssessmentDescriptionText>
        </AssessmentDescriptionView>
        <AssessmentDescriptionView>
            <AssessmentDescriptionText>
                If your symptoms worsen, call 811. We are experiencing heavy call volumes
                and will get to your call as quickly as we can.
            </AssessmentDescriptionText>
        </AssessmentDescriptionView>
        <AssessmentDescriptionView>
            <AssessmentDescriptionText>
        ...
        <CalloutSectionView>
            <CalloutSectionText>
                Please provide your contact information and healthcare number below. You
                will be contacted to confirm your symptoms and discuss next steps which
                may include a referral for testing.
            </CalloutSectionText>
        </CalloutSectionView>

        <CalloutSectionView>
            <CalloutSectionText>
                The COVID-19 test is only for people who currently have symptoms of the
                virus. The test does not show if you were infected in the past and are no
                longer symptomatic.
            </CalloutSectionText>
        </CalloutSectionView>
